...
export const PIPE_SPACING  = 8; // Increased from 5 for better rhythm
export const PIPE_SPAWN_Z  = -30; // Consistent spawn point
...
export const EXPLOSION_COLORS = [0x00ffff, 0xff00ff, 0xffffff, 0xff6600, 0xffff00];
